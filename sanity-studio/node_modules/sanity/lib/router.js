...
function RouterProvider(props) {
  ...
  }, [routerProp, state]), navigate = React.useCallback((nextStateOrOptions, maybeOptions) => {
  ...
  }, [onNavigate, resolvePathFromState, state]), handleNavigateStickyParams = React.useCallback((params_0, options_0 = {}) => navigate({
    stickyParams: params_0,
    ...options_0,
    state: void 0
  }), [navigate]), navigateIntent = React.useCallback((intentName_0, params_1, options_1 = {}) => {
    onNavigate({
...
const RouteScope = function(props) {
  ...
  }, [scope, __unsafe_disableScopedSearchParams]), resolvePathFromState = React.useCallback((nextState_0) => parent_resolvePathFromState(resolveNextParentState(nextState_0)), [parent_resolvePathFromState, resolveNextParentState]), navigate = React.useCallback((nextStateOrOptions, maybeOptions) => {
  ...
  }, [parent_navigate, resolveNextParentState]), childRouter = React.useMemo(() => {
...
exports.STICKY_PARAMS = STICKY_PARAMS;
