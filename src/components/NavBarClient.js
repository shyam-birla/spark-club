        ...
        {session && (
          <>
            <Link href="/profile" className="flex items-center gap-2 group cursor-pointer">
              {profileImageUrl && (
                <Image src={profileImageUrl} alt={session.user.name} width={40} height={40} className="rounded-full" />
              )}
              ...
              {session && (
                <div className="flex flex-col items-center gap-4">
                  <Link href="/profile" className="flex items-center gap-2">
                    {profileImageUrl && (<Image src={profileImageUrl} alt={session.user.name} width={32} height={32} className="rounded-full" />)}
