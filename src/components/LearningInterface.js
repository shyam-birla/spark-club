                ...
                {activeResource ? (
                    <div className="max-w-4xl mx-auto">
                        ...
                        <div className="mb-8">
                            ...
                            {activeResource.type === 'article' && activeResource.articleBody && ( <div className="prose lg:prose-xl bg-white p-6 md:p-8 rounded-lg shadow-md max-w-none"><PortableTextComponent value={activeResource.articleBody} /></div> )}
